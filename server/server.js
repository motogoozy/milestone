...
app.post(`/api/milestone`, mainController.addMilestone); //Adds a post to database (req.body)
app.put(`/api/milestone`, mainController.editMilestone) //Edits a milestone (req.body)
app.delete(`/api/milestone/:milestone_id`, mainController.deleteMilestone); //Deletes milestone from database
...
app.put(`/api/userData`, mainController.updateProfile)
